locals {
  ...
  remote_initrd = [
    "--name main https://builds.coreos.fedoraproject.org/prod/streams/${var.os_stream}/builds/${var.os_version}/${var.os_arch}/fedora-coreos-${var.os_version}-live-initramfs.${var.os_arch}.img",
  ]

  remote_args = [
    "initrd=main",
    "coreos.live.rootfs_url=https://builds.coreos.fedoraproject.org/prod/streams/${var.os_stream}/builds/${var.os_version}/${var.os_arch}/fedora-coreos-${var.os_version}-live-rootfs.${var.os_arch}.img",
